...
/**
 * Built per render, not as a module constant.
 *
 * The first answer names the chains, and it is mirrored into FAQPage
 * structured data. A hardcoded list therefore shipped a false claim to Google
 * the moment an adapter stopped producing — and markup that misrepresents the
 * page is a policy problem, not just a stale sentence.
 */
  ...
  return [
    {
      ...
      a: (
        <>
          SuperScout verzamelt de aanbiedingen van {chains}.{gap} Bekijk het
          overzicht per winkel op de{" "}
          <Link
            href="/winkels"
      ...
      aText: `SuperScout verzamelt de aanbiedingen van ${chains}.${gap}`,
    },
    {
    ...
    },
    {
      ...
      a: (
        <>
          Zoek een product (bijvoorbeeld “koffie” of “gehakt”) en je ziet in één
          lijst wat elke supermarkt er deze week voor vraagt. Filter op winkel
          of{" "}
          <Link
            href="/categorieen"
            className="font-bold underline decoration-deal decoration-2 underline-offset-2"
      ...
      <div className="pb-24 pt-8">
        ...
        >
          ...
          <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-ink-soft">
            SuperScout is een onafhankelijke vergelijker van
            supermarktaanbiedingen in Nederland. Geen folders doorbladeren: één
            zoekopdracht laat zien waar jouw boodschappen deze week het minst
            kosten. Lees{" "}
            <Link
              href="/product"
              className="font-bold text-ink underline decoration-deal decoration-2 underline-offset-2"
            >
