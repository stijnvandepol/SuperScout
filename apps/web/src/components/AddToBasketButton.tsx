  ...
  if (variant === "mini") {
    return (
      <button
        ...
        className={`rounded-full border px-3 py-2 font-mono text-[11px] font-bold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fresh ${
